...
class CreateItemView(APIView):
    ...
    def post(self, request):
        try:
            ...
            serializer.save()
            return Response(
                data={"New Item": serializer.data}, status=status.HTTP_201_CREATED
            )
...
class GetAllItemView(APIView):
    ...
    def get(self, request):
        try:
            ...
            if not items:
                return Response(
                    data={"Error": "No items found"}, status=status.HTTP_404_NOT_FOUND
                )
...
class CreateOrderView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            (201, "application/json"): OpenApiResponse(
                response=OrderSerializer(many=True), description="Created"
            ),
    ...
    def post(self, request):
        try:
            ...
            serializer.save()
            return Response(
                data={"New Order": serializer.data}, status=status.HTTP_201_CREATED
            )
        except ValidationError as e:
            return Response(data={"Error": str(e.args)}, status=e.status_code)
        except PermissionDenied:
            return Response(
                data={"Error": "Credentials weren't provided"},
...
class GetAllOrdersApiView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            (200, "application/json"): OpenApiResponse(
                response=OrderSerializer(many=True), description="Success"
            ),
            403: OpenApiResponse(description="Credentials weren't provided"),
            404: OpenApiResponse(description="Order does not exist"),
        },
    ...
    def get(self, request):
        try:
            ...
            if not orders:
                return Response(
                    data={"Error": "No orders found"}, status=status.HTTP_404_NOT_FOUND
                )
...
class UpdateOrderView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            (200, "application/json"): OpenApiResponse(
                response=OrderSerializer, description="Success"
            ),
            400: OpenApiResponse(description="No id"),
            403: OpenApiResponse(description="Credentials weren't provided"),
            404: OpenApiResponse(description="Order does not exist"),
...
class DeleteOrderView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            (204, "application/json"): OpenApiResponse(
                response=OrderSerializer, description="Created"
            ),
            400: OpenApiResponse(description="No id"),
            403: OpenApiResponse(description="Credentials weren't provided"),
            404: OpenApiResponse(description="Order does not exist"),
    ...
    def delete(self, request, *args, **kwargs):
        try:
            ...
            order.delete()
            return Response(
                data={"Message": "Successfully deleted order"},
                status=status.HTTP_204_NO_CONTENT,
            )
        except Order.DoesNotExist as e:
            return Response(data={"Error": str(e)}, status=status.HTTP_404_NOT_FOUND)
